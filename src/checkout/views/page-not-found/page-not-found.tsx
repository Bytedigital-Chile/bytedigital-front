...
export const PageNotFound = ({
	title = "Checkout no encontrado",
	message = "No pudimos encontrar tu sesión de checkout. Puede haber expirado o sido completada.",
}: PageNotFoundProps) => {
	return (
			...
			<main className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
				<div className="mx-auto max-w-md">
					...
					<p className="mt-6 text-center text-sm text-muted-foreground">
						Si crees que esto es un error, por favor intenta agregar artículos a tu carrito de nuevo o contacta a soporte.
					</p>
				</div>
			</main>
		</div>
